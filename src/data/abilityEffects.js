...
export const ABILITY_EFFECTS = {
  ...
  // 気質を見極める：自分が応援された時、その応援を出目+1に変える（base=代わり/＋=加えて）。判定者側UIが要るため後続。
  "気質を見極める程度の能力":   { passive: true, note: "自分が応援された時に出目を1つ+1（判定者側UI・後続実装）" },
  "気質を見極める程度の能力＋": { passive: true, note: "応援に加えて出目を1つ+1（判定者側UI・後続実装）" },
  // 動物を導く：応援時に選んだ出目を振り直す（base=1日1回/＋=制限なし）。複数選択の観戦UIが要るため後続。
  "動物を導く程度の能力":   { passive: true, note: "応援時に選んだ出目を振り直す（1日1回・観戦選択UI後続）" },
  "動物を導く程度の能力＋": { passive: true, note: "応援時に選んだ出目を振り直す（制限なし・観戦選択UI後続）" },
