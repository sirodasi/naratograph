  ...
  "finalBattleEnemies": [
    {
      ...
      "name": "霍青娥",
      "primary": false,
      "sc1effect": "【敵機マス×2】このスペルカードを使用するまでに回避側のいるマスに【弾幕】が配置されていた場合、それらを全て取り除く。",
      "sc1mode": "existing",
      "sc1name": "邪符「ヤンシャオグイ」",
      "sc1ref": "邪符「ヤンシャオグイ」",
      "sc2effect": "【ランダム×2】【敵機マス×1】このスペルカードは《宮古芳香からの絆》としても扱う。この絆により「応援」を行う場合は【スペルカード】を1点消費する。",
      "sc2mode": "existing",
      "sc2name": "通霊「トンリン芳香」",
      "sc2ref": "通霊「トンリン芳香」",
      "spellcard": 2
  ...
  "quests": [
    ...
    },
    {
      "enemy": {
        ...
        "life": 2,
        "name": "宮古芳香",
        "sc1effect": "【自機マス×1】このスペルカードの処理で【弾幕】を配置した上下のマスに、さらに【弾幕】を2つずつ配置する。",
        "sc1mode": "existing",
